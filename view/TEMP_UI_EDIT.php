...
&nbsp;<input type="button" value=".." class="date" id="f_btn3"></td>
    <td>
        <select   name="r2_d1_type" class=yellow  id="r2_d1_type"  >
            <option  value="<?php echo $epo['r2_d1_type']; ?>"><?php echo $epo['r2_d1_type']; ?></option>
            ...
            <option value="Intl Standard">Intl Standard</option>
            <option value="Intl Expedited">Intl Expdtd</option> -->
            <option value="Intl Express">Intl Express</option>
            <option value="Intl Economy">Intl Economy</option>
            <option value="Intl Priority">Intl Priority</option>
...
<td><input type="text" size="6"  onblur="__dt(this)"   name="r2_d2_date" id="f_date4"  value="<?php echo print_date($epo['r2_d2_date']); ?>" />&nbsp;<input type="button" value=".." class="date" id="f_btn4"></td>
    <td>
...
<td><input type="text" size="6"  onblur="__dt(this)"  name="r2_d3_date" id="f_date5" value="<?php echo print_date($epo['r2_d3_date']); ?>"  />&nbsp;<input type="button" value=".." class="date" id="f_btn5"></td>
    <td>
        <select  name="r2_d3_type">
            <option  value="<?php echo $epo['r2_d3_type']; ?>"><?php echo $epo['r2_d3_type']; ?></option>
            <option></option>
            <option value="Ground">Ground</option>
            <option value="3 Day">3 Day</option>
            <option value="2nd Day">2nd Day</option>
