...
<?php include("../includes/header_navigation.php"); ?>
 ...
 <div class="content">
 <div style="margin:10px 10px 5px 20px;"><b>Search Analytics</b></div>
 <div style="width:1140px; margin:auto; padding:20px; border:1px #333333 solid; height:700px; ">
<?php echo substr($disp_search['miscData'],0,strlen($disp_search['miscData'])-1); ?>
</div>
