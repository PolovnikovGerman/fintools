...
index=val;
	...
	var date=document.getElementById('_date'+val).value; 
...
var url="af_ajax_return.php";
url=url+"?q=update_art&cust="+cust+"&dsc="+dsc+"&notes="+notes+"&val="+val+"&date="+date+"&ord="+ordid; 
...
try{
	...
	document.getElementById('art_desc'+index).innerHTML = theResponse.two;
		...
		document.getElementById('art_date'+index).innerHTML = theResponse.four;
...
var v_date = document.getElementById('art_date'+val).innerHTML;
document.getElementById('art_cust'+val).innerHTML = "<input id=_cust"+val+" value=\""+v_c+"\" name=af_cust size=14>"; 
document.getElementById('art_desc'+val).innerHTML = "<input id=_desc"+val+" value=\""+v_d+"\" name=af_desc size=28>"; 
document.getElementById('art_date'+val).innerHTML = "<input id=_date"+val+" value=\""+v_date+"\" name=af_date size=5>";
document.getElementById('art_notes'+val).innerHTML = "<input id=_notes"+val+" value=\""+v_n+"\" name=af_notes size=30><input  type=\"button\" onclick=update_art("+val+","+ord+") value=\"s\" id=\"save\">"; 
