...
<?php include("../includes/header_navigation.php"); ?>
 ...
 <div style="width:960px; margin:auto; border:1px blue solid; height:600px; ">
<div style="float:left; width:250px; border:1px gray solid; height:500px;">
</div>
<div style="float:right; width:700px; border:1px gray solid;height:500px;">
</div>
</div>
