...
<div style="position:absolute; top:0; left:400px; z-index:1000;"><iframe name="atchiframe" src="attach_iframe.php" frameborder="0" marginwidth="0" marginheight="0"  height="19" width="175"></iframe></div>
<div id="att_wrap"></div>
<div class="wrap">
...
echo "<option>----------------------</option>";}
 ...
 echo "<li class=cat_inactive><a href=\"fullfillment.php\">Fullfillment</a></li>"; 
  echo "<li class=cat_inactive><a href=\"chinese.php\">Chinese</a></li>"; 
 echo "<li class=cat_active><a href=\"art.php\">Art Overview</a></li>"; 
 ...
 <div><table width="970px" border="0" cellpadding="0" cellspacing="0"   style="margin-left:10px;  border:1px #181818 solid; border-bottom:1px #818181 solid; " >
...
echo "<td width=\"250px\"  class=red_".$key['af_rush_ck'][$i]."   align=\"center\" id=art_desc$i  ondblclick=edit_af($i,".$key['af_order_id'][$i].")>".substr($key['af_desc'][$i],0,33)."</td>";
...
<span onclick=send_data(".$key['af_order_id'][$i].",'art')><img class=point src=\"../images/open_icon.gif\"></span><input type=hidden name=_type id=att_type value=art></td>";
}
else
{
echo "<td width=\"35px\" align=\"center\" class=td_border id=icon_".$key['af_order_id'][$i].">
<span onclick=send_data(".$key['af_order_id'][$i].",'art') class=point ><img src=\"../images/attch_icon.png\"></span></td>";
}
