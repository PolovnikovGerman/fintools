...
echo "<td width=\"120px\"   align=\"center\" id=af_cust$i class=\"tdbg small_font\" ondblclick=edit_af($i,".$key_c[$point]['af_order_id'][0].",".$key_c[$point]['ch_id'][0].")><a class=info href=#>".substr($key_c[$point]['af_cust'][0],0,19)."<span>".$key_c[$point]['af_cust'][0]."</span></a></td>";
echo "<td width=\"115px\" class=\"tdbg small_font\"    align=\"center\" id=af_desc$i  ondblclick=edit_af($i,".$key_c[$point]['af_order_id'][0].",".$key_c[$point]['ch_id'][0].")><a class=info href=#>".substr($key_c[$point]['af_desc'][0],0,19)."<span>".$key_c[$point]['af_desc'][0]."</span></a></td>";
